Feature: Cu Settings
  ...
  Scenario Outline: An site owner/administrator/developer should be able to access the settings contact page
    Given I am logged in as a user with the <role> role
    When I go to "admin/settings/getting-started/contact"
    Then I should not see <message>
  ...
  Scenario Outline: An site owner/administrator/developer should be able to access the settings feedback page
    Given I am logged in as a user with the <role> role
    When I go to "admin/settings/getting-started/feedback"
    Then I should not see <message>
  ...
  Scenario Outline: An site owner/administrator/developer should be able to access the settings redirects page
    Given I am logged in as a user with the <role> role
    When I go to "admin/settings/getting-started/redirects"
    Then I should not see <message>
  ...
  Scenario: A site_owner should see contact info form
    Given I am logged in as a user with the "site_owner" role
      And am on "admin/settings/getting-started/contact"
  ...
  Scenario: A site owner should see a webform in the feedback form list of one exists
    ...
    When I press the "Save" button
      And I go to "admin/settings/feedback"
