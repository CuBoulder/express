...
Examples:
| role             | message |
| developer        | "Site Name and Site Description" |
| administrator    | "Site Name and Site Description" |
| site_owner       | "Site Name and Site Description" |
| content_editor   | "Access denied" |
| edit_my_content  | "Access denied" |
| site_editor      | "Access denied" |
| edit_only        | "Access denied" |
| access_manager   | "Access denied" |
| configuration_manager | "Site Name and Site Description" |
