...
@api @testing_frontpage
 Scenario Outline: Devs, Admins, SOs and ConMgrs can set the Site Contact
...
Examples:
    ...
    | configuration_manager | "Let us help" |

# SOME ROLES CAN NOT SET SITE CONTACT
@api 
Scenario Outline: Most roles should not be able to set site name
Given I am logged in as a user with the <role> role
And am on "admin/settings/site-configuration/contact"
