(function ($) {
  $(document).ready(function(){
    var search = '<label for"icon-search-field" class="element-invisible">Icon Search</label><div class="icon-search"><input type="search" name="icon-search-field" id="icon-search-field" class="icon-search-field form-text" size="40" placeholder="Search by Icon Name"/></div><div class="icon-search-results element-invisible"></div>';
    ...
    $('.icon-search-field').on('input', function(event){
      ...
      if (query == '') {
        ...
        var count = $('.form-item-exbd-icon.icon-search-selected').length;
