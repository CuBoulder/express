<div class="expandable <?php print $expandable_classes; ?>" id="expandable-<?php print $variables['bean']->bid; ?>">
  ...
  <?php foreach ($content['sections'] as $section):?>
    ...
    <?php $section['display'] = $content['display']; ?>
