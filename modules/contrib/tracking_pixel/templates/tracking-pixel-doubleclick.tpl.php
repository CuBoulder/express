...
Activity name of this tag: <?php print check_plain($variables['doubleclick_activity']); ?>
URL of the webpage where the tag is expected to be placed: <?php print check_plain($variables['doubleclick_url']); ?>
This tag must be placed between the <body> and </body> tags, as close as possible to the opening tag.
Creation Date: <?php print check_plain($variables['doubleclick_creation']) ?>
-->
